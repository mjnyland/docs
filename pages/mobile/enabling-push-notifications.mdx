...
<img
  src="/images/mobile/enabling-push-notifications/settings.jpg"
...
<img
  src="/images/mobile/enabling-push-notifications/allow-notifications.jpg"
  alt="Main dashboard interface"
  height="300"
  className="rounded-lg"
/>
...
<img
  src="/images/mobile/enabling-push-notifications/android-settings.jpg"
  alt="Main dashboard interface"
  height="300"
  className="rounded-lg"
/>
...
<img
  src="/images/mobile/enabling-push-notifications/show-notifications.jpg"
  alt="Main dashboard interface"
  height="300"
  className="rounded-lg"
/>
