...
<img
  src="/images/mobile/adding-exporting-guest-list/guest-list-tab.PNG"
...
<img
  src="/images/mobile/adding-exporting-guest-list/guest-list-table.PNG"
  alt="Main dashboard interface"
  height="300"
  className="rounded-lg"
/>
...
<img
  src="/images/mobile/adding-exporting-guest-list/approved-tab.PNG"
  alt="Main dashboard interface"
  height="300"
  className="rounded-lg"
/>
...
<img
  src="/images/mobile/adding-exporting-guest-list/request-dropdown.PNG"
  alt="Main dashboard interface"
  height="300"
  className="rounded-lg"
/>
...
<img
  src="/images/mobile/adding-exporting-guest-list/guest-list-dropdown.PNG"
  alt="Main dashboard interface"
  height="300"
  className="rounded-lg"
/>
...
<img
  src="/images/mobile/adding-exporting-guest-list/export-as-pdf.PNG"
  alt="Main dashboard interface"
  height="300"
  className="rounded-lg"
/>
