...
<img
  src="/images/mobile/adding-lodging/lodging-dropdown.PNG"
...
<img
  src="/images/mobile/adding-lodging/group-search.PNG"
  alt="Main dashboard interface"
  height="300"
  className="rounded-lg"
/>
...
<img
  src="/images/mobile/adding-lodging/day-view-hotel.PNG"
  alt="Main dashboard interface"
  height="300"
  className="rounded-lg"
/>
