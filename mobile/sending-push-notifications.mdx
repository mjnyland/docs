...
<img
  src="/images/mobile/sending-push-notifications/send-message-dropdown.PNG"
...
<img
  src="/images/mobile/sending-push-notifications/group-search.PNG"
  alt="Main dashboard interface"
  height="300"
  className="rounded-lg"
/>
...
<img
  src="/images/mobile/sending-push-notifications/send.PNG"
  alt="Main dashboard interface"
  height="300"
  className="rounded-lg"
/>
